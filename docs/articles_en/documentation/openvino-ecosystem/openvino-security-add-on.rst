...
.. code-block:: sh
   ...
   uuid=$(uuidgen)
   /opt/ovsa/bin/ovsatool controlAccess -i model/<name-of-the-model>.xml model/<name-of-the-model>.bin -n "name of the model" -d "detailed name of the model" -v 0004 -p <name-of-the-model>.dat -m <name-of-the-model>.masterlic -k isv_keystore -g $uuid
