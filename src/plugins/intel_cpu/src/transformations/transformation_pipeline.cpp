...
void Transformations::PreLpt(const std::vector<ov::element::Type>& defaultPrecisions) {
    ...
    CPU_REGISTER_PASS_ARM(decompression_handling_manager, ov::pass::MarkDequantizationSubgraph, decompression_precisions, false, true);
    CPU_SET_CALLBACK_COMMON(decompression_handling_manager, [&](const_node_ptr &node) -> bool {
